    ...
    <PageContainer className="pb-10 pt-2">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4">אודות סיבוסון</h1>
        ...
        <div className="bg-white rounded-xl p-8 shadow-lg mb-8">
          <h2 className="text-2xl font-bold mb-6">על הפרויקט</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="flex items-center justify-center gap-2 bg-yellow-600 text-white p-4 rounded-lg">
